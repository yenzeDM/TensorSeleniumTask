...
class TensorAboutPage(BasePage):
    ...
    def pictures_have_the_same_height_and_width(self):
        ...
        picture = self.driver.find_element(*TensorAboutPageLocators.PICTURE_DEVELOPING_A_VLSI_SYSTEM)
        ...
        picture = self.driver.find_element(*TensorAboutPageLocators.PICTURE_PROMOTE_SERVICES)
        height = picture.get_attribute('height')
        width = picture.get_attribute('width')
        all_height.append(int(height))
        all_width.append(int(width))

        picture = self.driver.find_element(*TensorAboutPageLocators.PICTURE_CREATE_INFRASTRUCTURE)
        height = picture.get_attribute('height')
        width = picture.get_attribute('width')
        all_height.append(int(height))
        all_width.append(int(width))
